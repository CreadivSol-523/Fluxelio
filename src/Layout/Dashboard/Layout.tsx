...
const DashboardLayout = ({ children, isField = true }: DashboardLayoutProps) => {
   ...
   return (
      <div className="min-h-screen bg-cardBG flex overflow-hidden">
         ...
         >
            <div
               className={`dark:bg-layoutDarkBG bg-layoutLightBG rounded-t-2xl px-4 pb-4 lg:px-6 lg:pb-4 w-[98vw] overflow-hidden ${sidebarOpen ? "2xl:w-[96vw] xl:w-[94vw]  lg:w-[93vw] transition-all duration-300 ease-in-out" : "2xl:w-[86vw] xl:w-[84vw]  lg:w-[80vw] transition-all duration-500 ease-in-out"}`}
               style={{ height: "120vh" }}
            >
