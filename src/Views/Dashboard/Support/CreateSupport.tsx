   ...
   return (
      <Layout isField={false}>
         <div className="flex h-auto justify-center py-[5rem]">
            <div className="flex flex-col items-start gap-6 justify-self-start w-[40vw] py-10 px-8 border-2 dark:border-textColorDark border-[#6b6b6b8e] rounded-xl dark:bg-cardBG bg-white">
               ...
               <span className="border dark:border-textColorDark border-[#6b6b6b8e] py-2 px-4 rounded-lg dark:bg-layoutDarkBG bg-white ">
                  <p style={{ fontSize: "0.95em" }}>
                     We are sorry for the inconvenience. Please select the reason for the issue you are facing and provide the details below so we can assist you better. We are sorry for the inconvenience. Please select the reason for the issue you are facing and provide the details below so we can
                     assist you better.
                  </p>
               </span>
